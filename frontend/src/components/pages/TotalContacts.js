...
const TotalContacts = () => {
    ...
    const toggleSelectAll = () => {
        ...
        if (!selectAll) {
            setSelectedRows(contacts.map((contact) => contact._id));
        } else {
            setSelectedRows([]);
        }
    };
            ...
            <div className="right_div">
                <div className="top_right_div">
                    <div className="navbar">
                        ...
                        <div className="search_bar">
                            <img src="/Images/Vector.png" width='20px' height='20px' className="search_img" alt="search_bar" />
                            <input
                                type='email'
                ...
                <div className="middle_right_div">
                    ...
                    <div className="export">
                        &nbsp;<img src="/Images/export.png" alt="export" /><button onClick={exportToCSV} style={{ fontWeight: 'Bold', marginTop: '-1px', height: '25px', color: 'black', backgroundColor: 'white' }}>Export</button>
                    </div>
                </div>
